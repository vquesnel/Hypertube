...
var launch = function (connection, callback) {
    ...
    connection.query("CREATE TABLE IF NOT EXISTS `hypertube`.`comment` ( `id_film` INT(5) NOT NULL , `username` VARCHAR(255) NOT NULL , `imdb_id` VARCHAR(255) NOT NULL, `content` LONGTEXT NOT NULL, `date_message` VARCHAR(255) NOT NULL) ENGINE = InnoDB CHARSET=utf8mb4 COLLATE utf8mb4_bin;");
