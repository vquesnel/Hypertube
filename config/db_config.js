var launch = function (connection) {
	...
	connection.query("CREATE TABLE IF NOT EXISTS `hypertube`.`movies` ( `id` INT(5) NOT NULL AUTO_INCREMENT, `imdbid` VARCHAR(255) NOT NULL, `path` VARCHAR(255) NOT NULL, `quality` VARCHAR(255) NOT NULL,  PRIMARY KEY (`id`)) ENGINE = InnoDB CHARSET=utf8mb4 COLLATE utf8mb4_bin;");
